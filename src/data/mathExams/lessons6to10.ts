    ...
    questions: [
      {
        ...
        options: ['P = a × b', 'P = (a + b) × 2', 'P = 4 × a', 'P = a + b + c'],
      ...
      },
      {
        ...
        options: ['2.4 m', '4.8 m', '1.44 m', '3.6 m'],
        correctAnswerIndex: 1,
      ...
      },
      {
        ...
        options: ['15.7 cm', '31.4 cm', '62.8 cm', '25 cm'],
        correctAnswerIndex: 1,
      ...
      },
      {
        ...
        options: ['1.1 m', '2.198 m', '4.396 m', '3.14 m'],
        correctAnswerIndex: 1,
      ...
      },
      {
        ...
        options: ['21.98 m', '219.8 m', '2198 m', '21980 m'],
        correctAnswerIndex: 1,
      ...
      },
      {
        ...
        options: ['24 cm', '48 cm', '14 cm', '18 cm'],
        correctAnswerIndex: 0,
      ...
      },
      {
        ...
        options: ['15 cm', '30 cm', '22.5 cm', '56.25 cm'],
        correctAnswerIndex: 1,
      ...
      },
      {
        ...
        options: ['62.8 cm', '125.6 cm', '314 cm', '200 cm'],
        correctAnswerIndex: 1,
      ...
      },
      {
        ...
        options: ['628 m', '6280 m', '62.8 m', '62800 m'],
        correctAnswerIndex: 0,
  ...
  // =========================================================================
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ['96 cm²', '48 cm²', '24 cm²', '20 cm²'],
        correctAnswerIndex: 1,
      ...
      },
      {
        ...
        options: ['S = 2 × π × R', 'S = π × R²', 'S = π × D', 'S = (π × R) / 2'],
        correctAnswerIndex: 1,
      ...
      },
      {
        ...
        options: ['10 a', '100 a', '1000 a', '10 000 a'],
        correctAnswerIndex: 1,
      ...
      },
      {
        ...
        options: ['100 m²', '1000 m²', '10 000 m²', '100 000 m²'],
        correctAnswerIndex: 2,
      ...
      },
      {
        ...
        options: ['25 a', '250 a', '2500 a', '25 000 a'],
        correctAnswerIndex: 1,
      ...
      },
      {
        ...
        options: ['2500 m²', '25 000 m²', '250 000 m²', '250 m²'],
        correctAnswerIndex: 1,
      ...
      },
      {
        ...
        options: ['60 cm²', '120 cm²', '23 cm²', '46 cm²'],
        correctAnswerIndex: 1,
      ...
      },
      {
        ...
        options: ['150 ដុំ', '200 ដុំ', '1500 ដុំ', '250 ដុំ'],
        correctAnswerIndex: 0,
      ...
      },
      {
        ...
        options: ['314 cm²', '628 cm²', '1256 cm²', '100 cm²'],
        correctAnswerIndex: 0,
  ...
  // =========================================================================
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ['3.1 m', '3.2 m', '3.01 m', '31 m'],
        correctAnswerIndex: 0,
      ...
      },
      {
        ...
        options: ['30 ដប', '31 ដប', '32 ដប', '15.5 ដប'],
        correctAnswerIndex: 1,
      ...
      },
      {
        ...
        options: ['105 m²', '10.5 m²', '1050 m²', '100 m²'],
        correctAnswerIndex: 0,
      ...
      },
      {
        ...
        options: ['គុណនឹង 2', 'គុណនឹង 5', 'គុណនឹង 10', 'ចែកនឹង 2'],
        correctAnswerIndex: 0,
        explanation: '÷ (1/2) = × 2។'
      },
      {
      ...
      },
      {
        ...
        options: ['47.5 kg', '46.5 kg', '48.5 kg', '45.5 kg'],
        correctAnswerIndex: 0,
  ...
  // =========================================================================
  {
    ...
    questions: [
      ...
      },
      {
        ...
        subjectId: 'math',
        category: 'មេរៀនទី៩៖ ត.ច.រ និង ព.គុ.ត',
        text: 'គ្រូបង្រៀនម្នាក់មានប៊ិច 24 ដើម និងសៀវភៅ 36 ក្បាល។ គាត់ចង់ចែកកាដូដល់សិស្សឲ្យស្មើៗគ្នាដោយមិនឲ្យសល់។ តើគាត់អាចចែកបានច្រើនបំផុតប៉ុន្មានក្រុម?',
        options: ['6 ក្រុម', '12 ក្រុម', '18 ក្រុម', '24 ក្រុម'],
        correctAnswerIndex: 1,
      ...
      },
      {
        ...
        options: ['1, 2, 3, 4, 6, 12 (មាន 6 តួ)', '1, 2, 3, 6, 12', '2, 3, 4, 6', '12, 24, 36'],
        correctAnswerIndex: 0,
    ...
    questions: [
      {
        ...
        options: ['5/9', '23/20 ឬ 1 (3/20)', '8/20', '15/20'],
        correctAnswerIndex: 1,
      ...
      },
      {
        ...
        category: 'មេរៀនទី១០៖ បូកដកប្រភាគ',
        text: 'គណនា 7/9 - 4/9 = ?',
        options: ['3/9 ឬ 1/3', '3/0', '11/9', '3/18'],
        correctAnswerIndex: 0,
      ...
      },
      {
        ...
        category: 'មេរៀនទី១០៖ បូកដកប្រភាគ',
        text: 'គណនា 2 - 3/4 = ?',
        options: ['1/4', '5/4 ឬ 1 (1/4)', '1/2', '3/4'],
        correctAnswerIndex: 1,
      ...
      },
      {
        ...
        options: ['4/5', '8/10', '4/5 ឬ 8/10', '3/10'],
        correctAnswerIndex: 2,
