  ...
  return (
    <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#3D2012] via-[#59301A] to-[#2B150A] text-amber-50 p-6 sm:p-9 shadow-2xl shadow-amber-950/30 border border-amber-600/40">
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-3xl mx-auto">
        ...
        <div className="flex flex-wrap items-center justify-center gap-2.5 mb-7 text-xs sm:text-sm font-semibold">
          <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-amber-950/60 border border-amber-500/30 text-amber-200 backdrop-blur-xs">
          ...
          {onOpenMissions && (
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-amber-400/20 hover:bg-amber-400/30 border border-amber-400/40 text-amber-100 transition-colors cursor-pointer backdrop-blur-xs"
            >
