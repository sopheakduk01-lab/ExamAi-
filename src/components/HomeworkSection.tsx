...
const ALL_HOMEWORK_SHEETS: HomeworkSheet[] = [
  ...
  },
  {
    ...
    lessonTitle: 'ចំនួនទសភាគ',
    topicTitle: '❖ អំណាន សំណេរ ខ្ទង់ តម្លៃលេខ និងការប្រៀបធៀបចំនួនទសភាគ',
    icon: '📊',
    bgGradient: 'from-orange-500 to-amber-700',
    badgeColor: 'bg-orange-500 text-white',
    questions: [
      {
        id: 'hw_m2_p7_q1',
        type: 'text',
        questionText: '១. ចូរសរសេរប្រភាគ 87/1000 ជាចំនួនទសភាគ៖',
        placeholder: 'ឧ. 0.087',
        correctAnswer: '0.087',
        explanation: '87 / 1000 = 0.087 (សូន្យក្បៀសសូន្យប្រាំបីប្រាំពីរ)។'
      },
      {
        id: 'hw_m2_p7_q2',
        type: 'choice',
        questionText: '២. តើចំនួនទសភាគ 34.120 អានជាអក្សរយ៉ាងដូចម្តេច?',
        options: [
          'ក. សាមសិបបួនក្បៀសមួយរយម្ភៃ',
          'ខ. សាមសិបបួនក្បៀសមួយពីរ',
          'គ. សាមសិបបួនក្បៀសដប់ពីរ',
          'ឃ. សាមសិបបួនចុចដប់ពីរ'
        ],
        correctAnswer: 'ក. សាមសិបបួនក្បៀសមួយរយម្ភៃ',
        explanation: '34.120 អានថា "សាមសិបបួនក្បៀសមួយរយម្ភៃ" ឬ "សាមសិបបួនក្បៀសមួយពីរ"។'
      },
      {
        id: 'hw_m2_p8_q1',
        type: 'choice',
        questionText: '៣. ក្នុងចំនួន 36.458 តើលេខ ៥ ស្ថិតនៅខ្ទង់អ្វី ហើយមានតម្លៃប៉ុន្មាន?',
        options: [
          'ក. ខ្ទង់ភាគដប់ មានតម្លៃ ០.៥',
          'ខ. ខ្ទង់ភាគរយ មានតម្លៃ ០.០៥',
          'គ. ខ្ទង់ភាគពាន់ មានតម្លៃ ០.០០៥',
          'ឃ. ខ្ទង់រាយ មានតម្លៃ ៥'
        ],
        correctAnswer: 'ខ. ខ្ទង់ភាគរយ មានតម្លៃ ០.០៥',
        explanation: 'លេខ ៥ នៅក្រោយក្បៀសពីរខ្ទង់ ស្ថិតនៅខ្ទង់ភាគរយ មានតម្លៃ ០.០៥។'
      },
      {
        id: 'hw_m2_p9_q1',
        type: 'choice',
        questionText: '៤. ចូរបង្គត់ចំនួន 8.547 ត្រឹមខ្ទង់ភាគដប់៖',
        options: ['ក. 8.5', 'ខ. 8.6', 'គ. 8.55', 'ឃ. 8.50'],
        correctAnswer: 'ក. 8.5',
        explanation: 'ខ្ទង់ភាគរយគឺ ៤ (< ៥) ដូច្នេះបង្គត់ត្រឹមភាគដប់គឺ 8.5។'
      },
      {
        id: 'hw_m2_p9_q2',
        type: 'text',
        questionText: '៥. បង្គត់ចំនួន 234.605 ត្រឹមខ្ទង់ភាគរយ៖',
        placeholder: 'សរសេរចម្លើយ...',
        correctAnswer: '234.61',
        explanation: 'ខ្ទង់ភាគពាន់គឺ ៥ (≥ ៥) ដូច្នេះបង្គត់ឡើងបាន 234.61។'
      },
      {
        id: 'hw_m2_p11_q1',
        type: 'choice',
        questionText: '៦. ប្រៀបធៀបចំនួន 25.742 និង 25.738៖',
        options: ['ក. 25.742 > 25.738', 'ខ. 25.742 < 25.738', 'គ. 25.742 = 25.738'],
        correctAnswer: 'ក. 25.742 > 25.738',
        explanation: 'ប្រៀបធៀបខ្ទង់ភាគរយ៖ ៤ > ៣ ដូច្នេះ 25.742 > 25.738។'
      }
    ]
  },
  {
    ...
    lessonTitle: 'វិធីបូក និងវិធីដកចំនួនទសភាគ',
    topicTitle: '❖ ប្រមាណវិធីបូក និងដកចំនួនទសភាគ និងចំណោទ',
    icon: '➕',
    bgGradient: 'from-orange-500 to-amber-700',
    badgeColor: 'bg-orange-500 text-white',
    questions: [
      ...
      },
      {
        id: 'hw_m3_p13_q2',
        type: 'choice',
        questionText: '២. គណនា៖ 25.421 + 26 = ?',
        options: ['ក. 411.421', 'ខ. 52.421', 'គ. 51.421', 'ឃ. 41.421'],
        correctAnswer: 'គ. 51.421',
        explanation: '25.421 + 26 = 51.421។'
      },
      {
        id: 'hw_m3_p14_q1',
        type: 'choice',
        questionText: '៣. គណនាផលបូក 27.345 + 6.437 = ?',
        options: ['ក. 213.7712', 'ខ. 33.782', 'គ. 33.772', 'ឃ. 23.782'],
      ...
      },
      {
        id: 'hw_m3_p16_q1',
        type: 'text',
        questionText: '៤. គណនា៖ 0.857 - 0.287 = ?',
        placeholder: 'សរសេរចម្លើយ...',
        correctAnswer: '0.57',
      ...
      },
      {
        id: 'hw_m3_p20_q1',
        type: 'text',
        questionText: '៦. ពូហំលក់ស្រូវលើកទី១ បាន 85kg លើកទី២ បាន 75.50kg និងលើកទី៣ បាន 67.25kg។ តើគាត់លក់ស្រូវសរុបបានប៉ុន្មានគីឡូក្រាម?',
        placeholder: 'សរសេរលទ្ធផលជា kg...',
        correctAnswer: '227.75',
        explanation: '85 + 75.50 + 67.25 = 227.75 kg។'
      }
    ]
  },
  {
